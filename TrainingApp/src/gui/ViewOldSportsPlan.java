 ...
 * @author Alejandro
 */
public class ViewOldSportsPlan extends javax.swing.JFrame {
    private App m;
    private Athlete a;

    /**
     * Creates new form ViewOldSportsPlan
     */
    public ViewOldSportsPlan() {
        initComponents();
    }
    public ViewOldSportsPlan(App m, Athlete a) {
        initComponents();
        this.m = m;
        
        this.a = a;
        
        this.sportDayList.setListData(a.ViewOldSportPlan());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Old sport days:");
    ...
    private void sportDayListValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_sportDayListValueChanged
        ...
        SportDay s = this.a.getOldSportPlan().get(dateIndex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewOldSportsPlan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewOldSportsPlan().setVisible(true);
            }
        });
    }
